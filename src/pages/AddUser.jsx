...
const UserDataForm = () => {
  ...
  const saveLoan = (index) => {
    ...
    const requiredFields = ['amount', 'type', 'sanction_date', 'end_date', 'lender_branch', 'account_number'];
      ...
      <main className="container mx-auto px-4 pt-24 pb-12">
        <Card className="max-w-4xl mx-auto p-6 space-y-8">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-semibold">Personal Details (continued)</h2>
            ...
            <div>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleInputChange('personal_details', 'dob', e.target.value)}
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleInputChange('personal_details', 'age', e.target.value)}
                />
              </div>
              <div>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleInputChange('personal_details', 'contact_number', e.target.value)}
                />
              </div>
              <div>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) => handleInputChange('personal_details', 'address', e.target.value)}
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleInputChange('personal_details', 'pincode', e.target.value)}
                />
              </div>
              <div>
                ...
                <select
                  ...
                  onChange={(e) => handleInputChange('personal_details', 'state', e.target.value)}
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleInputChange('documents', 'aadhar_number', e.target.value)}
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleInputChange('documents', 'pan_number', e.target.value)}
                />
              </div>
              <div className="col-span-2">
            <Label>Upload Documents</Label>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {['aadhar_front_image', 'aadhar_back_image', 'pan_card_image'].map((field) => (
                  ...
                  {!formData.documents[field] ? (
                    <>
                      <input
                        ...
                        id={field}
                        className="hidden"
                        onChange={(e) => handleFileUpload('documents', field, e)}
                        accept="image/*"
                      />
                      <label htmlFor={field} className="cursor-pointer flex flex-col items-center">
                        <Upload className="mb-2" />
                        <span className="text-sm">{field.split('_').map(word => word.charAt(0).toUpperCase() + word.slice(1)).join(' ')}</span>
                      </label>
                    </>
                  ) : (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleInputChange('nominee_details', 'name', e.target.value)}
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleInputChange('nominee_details', 'relationship', e.target.value)}
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleInputChange('nominee_details', 'dob', e.target.value)}
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleInputChange('nominee_details', 'age', e.target.value)}
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleInputChange('nominee_details', 'aadhar_number', e.target.value)}
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleInputChange('nominee_details', 'pan_number', e.target.value)}
                />
              </div>
            </div>
          </section>
          ...
          {savedLoans.map((loan, index) => (
            <Card key={index} className="p-4">
              <div className="flex justify-between items-start mb-2">
                <h3 className="font-semibold text-lg">{loan.type || 'Untitled Loan'}</h3>
                <button
              ...
              <div className="space-y-2 text-sm">
                <p><span className="font-medium">Amount:</span> ₹{loan.amount.toLocaleString()}</p>
                <p><span className="font-medium">Sanction Date:</span> {new Date(loan.sanction_date).toLocaleDateString()}</p>
                <p><span className="font-medium">End Date:</span> {new Date(loan.end_date).toLocaleDateString()}</p>
                <p><span className="font-medium">Lender Branch:</span> {loan.lender_branch}</p>
                <p><span className="font-medium">Account:</span> {loan.account_number}</p>
              </div>
            </Card>
          ))}
        </div>
      ...
      {formData.loans.map((loan, index) => (
        <Card key={index} className="p-4 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <Label htmlFor={`sanction_date_${index}`}>Sanction Date</Label>
              <Input
                id={`sanction_date_${index}`}
                type="date"
                value={loan.sanction_date}
                onChange={(e) => updateLoan(index, 'sanction_date', e.target.value)}
                required
              />
            </div>
            <div>
            ...
            <div>
              <Label htmlFor={`lender_branch_${index}`}>Lender Branch</Label>
              <Input
                id={`lender_branch_${index}`}
                value={loan.lender_branch}
                onChange={(e) => updateLoan(index, 'lender_branch', e.target.value)}
                required
              />
            </div>
            <div>
              <Label htmlFor={`account_number_${index}`}>Account Number</Label>
              <Input
                id={`account_number_${index}`}
                value={loan.account_number}
                onChange={(e) => updateLoan(index, 'account_number', e.target.value)}
                required
              />
            </div>
          </div>
